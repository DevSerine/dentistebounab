...
const PRODUCTION_SITE_URL = "https://dentistebounab.netlify.app";
...
export const SITE_URL = isValidPublicUrl
  ...
  : PRODUCTION_SITE_URL;
  /**
   * NOTE: si vous déployez sur Netlify, utilisez https://dentistebounab.netlify.app
   * ou, mieux, définissez `NEXT_PUBLIC_SITE_URL` dans les variables d'environnement
   * de votre build Netlify pour éviter d'avoir à modifier ce fichier.
   */
