...
export default function HeroCarousel() {
  return (
    <${d} id="home" className="container-fluid p-0 mb-5 site-section">
      <${d} id="header-carousel" className="carousel slide carousel-fade" data-bs-ride="carousel">
        <${d} className="carousel-inner">
          <${d} className="carousel-item active">
            <${d} className="carousel-media">
              <SiteImage
                fill
            ...
            <${d} className="carousel-caption d-flex flex-column align-items-center justify-content-center">
              <${d} className="hero-content p-3">
...
fs.writeFileSync("components/HeroCarousel.jsx", jsx);
